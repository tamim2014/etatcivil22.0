 	    ...
 	    <div style="width:80%; margin-left:10%; height:30%; ">
                <a href="accueil.php"   > 
				    <div  class="kangalaheMenu" style="padding-top : 20px;  height: 50px; width:120%; left:-15px; "  >  
					   <input type="button"  value="Accueil"   style="background-color:#cdbe9f; height:30px;   display: block;  margin : auto;  "/>
					</div>     
				</a>
				<p> &nbsp;</p>
				<div class="kangalaheMenu" style=" padding-top:20px;  height: 50px;  width:120%; left:-15px; ">			  
				 ...
				 <div class="kangalaheMenu" style=" padding-top:20px;  height: 50px;  width:100%; left:0; ">
